# Generated by Powerlevel10k configuration wizard on 2020-01-29 at 22:18 CST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 00896.
# Wizard options: powerline, classic, darkest, vertical separators, blurred heads,
# blurred tails, 2 lines, dotted, right frame, compact, concise, transient_prompt,
